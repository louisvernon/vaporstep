...
class PlayfieldConfigTests(unittest.TestCase):
    def test_basic_occupancy_grace_is_symmetric(self):
        self.assertAlmostEqual(HIT_WINDOW_SECONDS, 0.10)
        self.assertAlmostEqual(OCCUPANCY_GRACE_SECONDS, 0.10)
        self.assertAlmostEqual(HIT_WINDOW_SECONDS, OCCUPANCY_GRACE_SECONDS)
